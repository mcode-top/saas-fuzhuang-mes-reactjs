...
import type { BusCustomerAddressType, BusCustomerCompanyType, BusCustomerContacterType } from "./typing";
...
export function fetchCustomerCompanyList() {
  return request<RESULT_SUCCESS<BusCustomerCompanyType[]>>(
...
export function fetchCurrentCustomerContacterList(id: number) {
  return request<RESULT_SUCCESS<BusCustomerContacterType[]>>(
    '/customer/contacter-list/' + id,
    {
      method: 'GET',
    },
  );
...
export function fetchCurrentCustomerAddressList(id: number) {
  return request<RESULT_SUCCESS<BusCustomerAddressType[]>>(
