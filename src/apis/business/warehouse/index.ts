...
import { BusWarehouseGoodsType, BusWarehouseShelfType, BusWarehouseType, BusWarehouseGoodsPageParamQuery, BusWarehousePutOutInGoodsDto } from "./typing";
...
/**@name 通过货架Id获取货品分页 */
export function fetchShelfIdToGoodsList(shelfId: number, data: PAGINATION_QUERY.Param<BusWarehouseGoodsPageParamQuery>) {
  return request<RESULT_SUCCESS<PAGINATION_QUERY.Result<BusWarehouseGoodsType>>>("/warehouse/goods/page/" + shelfId, {
    method: "POST",
    data
  })
}
