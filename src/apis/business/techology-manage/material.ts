...
import { MaterialPageParamQuery } from "./typing";
...
export function fetchNameListMaterial(searchMaterial: string) {
  return request<RESULT_SUCCESS<{ name: string, code: number }[]>>("/material/all/name-to-id/" + searchMaterial, {
    method: "GET",
  })
}
