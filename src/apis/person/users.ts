...
import type { DeptTreeType, OperationDeptDTO, OperationUserDTO, UserListItem, UserListPageParamOrder, UserListPageParamQuery } from "./typings";
 ...
 * 分页获取用户列表
 */
export function fetchUserList(data: PAGINATION_QUERY.Param<UserListPageParamQuery, UserListPageParamOrder>) {
