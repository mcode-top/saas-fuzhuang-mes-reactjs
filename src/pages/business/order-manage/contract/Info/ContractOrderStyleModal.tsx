...
const ContractOrderStyleModal: React.FC<{
  ...
  return (
    ...
    >
              ...
              {styleType === BusOrderStyleTypeEnum.SpotGoods ? (
                <ProFormGroup>
                  ...
                  <MaterialFillStyleDemand
                    ...
                    action={formRef.current}
                  />
                  <ProFormText name="style" width="md" readonly={true} label="产品名称(款式)" />
                </ProFormGroup>
              ) : null}
            </>
          );
      ...
      <ProFormGroup>
        <ProFormMoney fieldProps={{ precision: 4 }} name="印刷单价" min={0} label="印刷单价" />
        <ProFormMoney fieldProps={{ precision: 4 }} name="绣花单价" min={0} label="绣花单价" />
        <ProFormMoney fieldProps={{ precision: 4 }} name="版费" min={0} label="版费" />
      </ProFormGroup>
  ...
  return (
    ...
    >
      <ProFormGroup key="group">
        ...
        <ProFormMoney fieldProps={{ precision: 4 }} name="price" min={0} width={150} label="单价" />
