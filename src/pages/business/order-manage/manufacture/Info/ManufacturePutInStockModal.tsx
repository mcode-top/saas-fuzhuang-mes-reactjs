...
const ManufacturePutInStockModal: React.FC<{
...
export default forwardRef(ManufacturePutInStockModal);
  ...
  return (
    <>
      ...
      {props.readonly ? (
        ...
        >
          <ProFormGroup>
            <ProFormText colProps={{ span: 1 }} name="contractGoodsId" label="id" readonly={true} />
            <ProFormText
              colProps={{ span: 5 }}
              name="materialInfo"
              readonly={true}
              label="物料信息"
            />
            <ProFormText colProps={{ span: 3 }} name="sizeInfo" readonly={true} label="尺码信息" />
            <ProFormText colProps={{ span: 3 }} name="color" readonly={true} label="颜色" />
            <ProFormDigit
              colProps={{ span: 3 }}
              name="needQuantity"
              readonly={true}
  ...
  return (
    <Table
      ...
      columns={[
        ...
        { title: '已出库数量', dataIndex: 'beenOutQuantity' },
        {
          title: '现有库存',
          dataIndex: 'goods',
...
export const PutInStockFormList = React.forwardRef(PutInStockFormListDom);
