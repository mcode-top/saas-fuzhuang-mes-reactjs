...
const originRoutes: Router[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/order-manage/statisitics/contract-sales',
        key: 'ContractSalesCommission',
        name: '销售数据查询',
        hideInMenu: true,
        white: true,
        component: './business/order-manage/statisitics/ContractSalesCommission',
      },
      {
        path: '/order-manage/statisitics/date-record-piece',
        key: 'DateRecordPiece',
        name: '统计整体计件数与工资',
        hideInMenu: true,
        white: true,
        component: './business/order-manage/statisitics/DateRecordPiece',
      },
      {
        path: '/order-manage/statisitics/worker-date-record-piece',
        key: 'DateWorkerRecordPiece',
        name: '统计单个员工计件数与工资',
        hideInMenu: true,
        white: true,
        component: './business/order-manage/statisitics/DateWorkerRecordPiece',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    hideInMenu: true,
    white: true,
    component: './business/warehouse/Warehouse/FuzzySearchGoods',
  },
  {
    name: '客户管理',
    path: '/customer',
